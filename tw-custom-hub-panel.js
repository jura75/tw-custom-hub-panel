(function() {
    ...
    function loadTabContent(tabId) {
        ...
        if (tabId === '1') {
            ...
            const categories = [
                { key: 'офф-источник', name: 'Офф-источник', color: '#b22222' },
                { key: 'двор4-источник', name: 'Двор4-источник', color: '#5b3511' },
                { key: 'двор2-источник', name: 'Двор2-источник', color: '#5b3511' },
                { key: 'каты-исток', name: 'каты-исток', color: '#5b3511' },
                { key: 'спам-источник', name: 'Спам-источник', color: '#5b3511' },
                { key: 'дефф-источник', name: 'Дефф-источник', color: '#00008b' }
            ];
