                ...
                <div style="background: #f4ecd8; padding: 8px; border-bottom: 1px solid #c5a059; display: flex; align-items: center; gap: 8px; flex-wrap: wrap;">
                    ...
                    <div style="position: relative; display: inline-block; margin-left: 10px;">
                        ...
                        <div id="save_menu" style="display: none; position: absolute; top: 100%; left: 0; background: #fff8eb; border: 1px solid #7d510f; z-index: 120000; box-shadow: 0 4px 8px rgba(0,0,0,0.2); width: 130px;">
                            ...
                            <div class="save-option" data-cat="раскатка-источник" style="padding: 6px 10px; cursor: pointer; border-bottom: 1px solid #e3d0b1; font-weight: bold;">Раскатка-источник</div>
